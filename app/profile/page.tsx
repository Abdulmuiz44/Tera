          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="rounded-[28px] bg-tera-panel border border-white/10 p-6 shadow-glow-md">
              ...
              <div className="space-y-4">
                <div>
                  <div className="flex items-baseline gap-2 mb-2">
                    <span className="text-3xl font-bold text-white">{profile.monthlyChats}</span>
                    <span className="text-white/60">
                      / {chatLimit === 'unlimited' ? '∞' : chatLimit} this month
                    </span>
                  </div>
                ...
                {profile.subscriptionPlan === 'free' && chatPercentage >= 80 && (
                  <div className="rounded-lg bg-blue-500/10 border border-blue-500/30 p-3">
                    <p className="text-sm text-blue-400">
                      ⚠️ You're approaching your monthly limit. <Link href="/pricing" className="underline font-medium">Upgrade to Pro</Link> for unlimited chats.
                    </p>
                  </div>
                )}
              </div>
