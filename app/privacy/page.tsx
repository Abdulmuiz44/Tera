    ...
    return (
        <div className="mx-auto max-w-4xl px-6 py-12 md:py-20 text-white">
            ...
            <div className="prose prose-invert max-w-none space-y-8 text-white/80">
                ...
                <section>
                    <h2 className="mb-4 text-2xl font-semibold text-white">2. How We Use Your Information</h2>
                ...
                <section>
                    <h2 className="mb-4 text-2xl font-semibold text-white">3. Data Security</h2>
                    <p>
                ...
                <section>
                    <h2 className="mb-4 text-2xl font-semibold text-white">4. Third-Party Services</h2>
                    <p>
