                    ...
                    {!submitted ? (
                        <>
                            ...
                            <form onSubmit={handleEmailSubmit} className="mb-6 space-y-4">
                                <div>
                                    <label className="block text-tera-primary/80 text-sm font-medium mb-2">Email (Optional)</label>
                                    <input
                                        type="email"
                                        value={email}
                        ...
                        <>
                            ...
                            <div className="mb-6 p-4 bg-tera-primary text-tera-bg border border-tera-primary rounded-lg">
                                <p className="text-sm">Ready to complete your signup with Google</p>
                            </div>
