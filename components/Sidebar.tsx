...
export const navigation = [
  ...
  { label: 'Deep research', icon: 'research', href: '/new?mode=deep-research' },
          ...
          <nav className="space-y-1">
            {navigation.map((item) => {
              ...
              const isActive = isNewChat
                ...
                : (item.href.startsWith('/history') && pathname?.startsWith('/history')) ||
                  (item.href.startsWith('/tools') && pathname?.startsWith('/tools')) ||
                  (item.href.startsWith('/images') && pathname?.startsWith('/images')) ||
                  pathname === item.href
